...
var require_iterator = __commonJS({
  "node_modules/superagent/node_modules/yallist/iterator.js"(exports2, module2) {
    "use strict";
...
var require_test = __commonJS({
  "node_modules/supertest/lib/test.js"(exports2, module2) {
    ...
    var Test = class extends Request {
       ...
       * @api public
       */
      constructor(app, method, path2) {
        super(method.toUpperCase(), path2);
        this.redirects(0);
        this.buffer();
        this.app = app;
        this._asserts = [];
        this.url = typeof app === "string" ? app + path2 : this.serverAddress(app, path2);
      }
      /**
...
describe("My first test", () => {
  it("Should test the server running", () => __async(exports, null, function* () {
    const app = new App().app;
    const response = yield (0, import_supertest.default)(app).get("/");
